...
class EmployeePersonalDetailsData(BaseModel):
    """Personal details data for employee reports"""
    employee_id: str
    last_name: str
    first_name: str
...
class EmployeeBasicProfileData(BaseModel):
    """Basic profile data for employee reports"""
    name: str
    company_name: Optional[str] = None
...
class EmployeePersonalDetailsReportResponse(BaseModel):
    """Response wrapper for employee personal details reports"""
    success: bool
    data: List[EmployeePersonalDetailsData] | List[GroupedReportData]
    summary: ReportSummary
    is_grouped: Optional[bool] = False

class EmployeeBasicProfileReportResponse(BaseModel):
    """Response wrapper for employee basic profile reports"""
    success: bool
    data: List[EmployeeBasicProfileData] | List[GroupedReportData]
    summary: ReportSummary
    is_grouped: Optional[bool] = False
