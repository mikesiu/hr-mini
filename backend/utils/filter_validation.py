...
FILTER_APPLICABILITY = {
    ...
    # Employee Directory and Personal Details specific filters
    "include_inactive": [ReportType.EMPLOYEE_DIRECTORY, ReportType.EMPLOYEE_PERSONAL_DETAILS, ReportType.EMPLOYEE_BASIC_PROFILE],
    "position": [ReportType.EMPLOYEE_DIRECTORY, ReportType.EMPLOYEE_PERSONAL_DETAILS, ReportType.EMPLOYEE_BASIC_PROFILE],
    "hire_date_from": [ReportType.EMPLOYEE_DIRECTORY, ReportType.EMPLOYEE_PERSONAL_DETAILS, ReportType.EMPLOYEE_BASIC_PROFILE],
