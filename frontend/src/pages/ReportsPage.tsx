    ...
    try {
      ...
      switch (selectedReportType) {
        ...
        case 'employee_personal_details':
          response = await reportsAPI.employeePersonalDetails(filters);
          break;
        case 'employee_basic_profile':
          response = await reportsAPI.employeeBasicProfile(filters);
          break;
      ...
      if (group.records && group.records.length > 0) {
        group.records.forEach((record: any) => {
          ...
          switch (selectedReportType) {
            ...
            case 'employee_basic_profile':
              html += `
                <td style="border: 1px solid #000; padding: 8px;">${record.name || 'N/A'}</td>
                <td style="border: 1px solid #000; padding: 8px;">${record.company_name || 'N/A'}</td>
                <td style="border: 1px solid #000; padding: 8px;">${record.current_position || 'N/A'}</td>
                <td style="border: 1px solid #000; padding: 8px;">${record.age ?? 'N/A'}</td>
              `;
              break;
            default:
        ...
        reportData.forEach(profile => {
          tableHtml += `
            <tr>
              ...
              <td>${profile.current_position || 'N/A'}</td>
