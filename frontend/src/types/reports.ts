...
// Employee Personal Details Report Data
export interface EmployeePersonalDetailsData {
  employee_id: string;
  last_name: string;
  first_name: string;
  sin?: string;
...
export interface EmployeePersonalDetailsReportResponse {
  success: boolean;
  data: EmployeePersonalDetailsData[] | GroupedReportData[];
  summary: ReportSummary;
  is_grouped?: boolean;
}

// Employee Basic Profile Report Data
export interface EmployeeBasicProfileData {
  name: string;
  company_name?: string;
...
export interface EmployeeBasicProfileReportResponse {
  success: boolean;
  data: EmployeeBasicProfileData[] | GroupedReportData[];
  summary: ReportSummary;
  is_grouped?: boolean;
}
