...
/** Returned after DELETE /employees/{id} */
export interface EmployeeDeleteConsistency {
  consistent: boolean;
  employee_row_count: number;
  related_row_total: number;
  by_table: Record<string, number>;
}

export interface EmployeeDeleteResponse {
  message: string;
  consistency: EmployeeDeleteConsistency;
}
...
export const reportsAPI = {
  ...
  employeePersonalDetails: (params?: {
    company_id?: string;
    department?: string;
    employee_status?: string;
    employee_id?: string;
    ...
    group_by?: string;
    group_by_secondary?: string;
  }) => apiClient.get('/reports/employee-personal-details', { params }),

  // Employee Basic Profile Report
  employeeBasicProfile: (params?: {
    company_id?: string;
    department?: string;
    employee_status?: string;
    employee_id?: string;
    ...
    group_by?: string;
    group_by_secondary?: string;
  }) => apiClient.get('/reports/employee-basic-profile', { params }),
