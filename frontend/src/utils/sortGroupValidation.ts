...
export const SORT_FIELD_APPLICABILITY = {
  ...
  employee_name: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  employee_id: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  company_name: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  department: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  position: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  status: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  hire_date: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
...
export const GROUP_FIELD_APPLICABILITY = {
  ...
  employee: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  company: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  department: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  position: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
  status: ['employee_directory', 'employment_history', 'leave_balance', 'leave_taken', 'salary_analysis', 'work_permit_status', 'employee_personal_details', 'employee_basic_profile', 'expense_reimbursement'],
